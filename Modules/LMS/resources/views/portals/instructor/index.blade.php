...
<x-dashboard-layout>
    <x-slot:title> {{ translate('Tableau de bord') }} </x-slot:title>
    <div class="grid grid-cols-12 gap-x-4">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <div class="text-sm leading-none text-gray-500 dark:text-dark-text">
                                {{ $data['total_course'] }} {{ translate('Cours') }}</div>
                        </div>
                    </div>
        ...
        <div class="col-span-full lg:col-span-8 card">
            <div class="grid grid-cols-12 gap-4 mb-4">
                ...
                <div class="col-span-full sm:col-span-4 p-4 dk-border-one rounded-xl h-full dk-theme-card-square">
                    <div class="flex-center-between">
                        <h6 class="leading-none text-gray-500 dark:text-dark-text font-semibold">
                            {{ translate('Montant des achats') }} </h6>
                    </div>
                    <div
                ...
                <div class="col-span-full sm:col-span-4 p-4 dk-border-one rounded-xl h-full dk-theme-card-square">
                    <div class="flex-center-between">
                        <h6 class="leading-none text-gray-500 dark:text-dark-text font-semibold">
                            {{ translate('Frais de plateforme') }} </h6>
                    </div>
                    <div
                        class="pt-3 bg-[url('../../assets/images/card/pattern.png')] dark:bg-[url('../../assets/images/card/pattern-dark.png')] bg-no-repeat bg-100% flex gap-4 mt-3">
                        <div class="pb-8 shrink-0">
                ...
                <div class="col-span-full sm:col-col-span-4 p-4 dk-border-one rounded-xl h-full dk-theme-card-square">
                    <div class="flex-center-between">
                        <h6 class="leading-none text-gray-500 dark:text-dark-text font-semibold">
                            {{ translate('Total des bundles') }} </h6>
                    </div>
                    <div
                        class="pt-3 bg-[url('../../assets/images/card/pattern.png')] dark:bg-[url('../../assets/images/card/pattern-dark.png')] bg-no-repeat bg-100% flex gap-4 mt-3">
                        <div class="pb-8 shrink-0">
        ...
        <!-- Fin du tableau des revenus de l'instructeur -->

        <!-- Début du tableau des meilleures ventes de cours -->

        @if (isset($topCourses) && $topCourses->count() > 0)
            <div class="col-span-full card">
                <div class="flex-center-between mb-6">
                    <h6 class="card-title"> {{ translate('Cours les plus performants') }} </h6>
        ...
        @endif
        <!-- Fin du tableau des meilleures ventes de cours -->
    </div>
</x-dashboard-layout>
